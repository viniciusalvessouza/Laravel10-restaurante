                ...
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method="POST" action="{{route('admin.categories.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input value="{{old('name')}}" type="text" id="name" name="name" class="block w-full appearence-none bg-white border-gray-400 rounded-md py-2 px-3 text-base leading-normal @error('name') border-red-400 @else is-valid @enderror">
                            </div>
                        </div>
